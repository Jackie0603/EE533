...
// /___/   /\     Timestamp : 02/01/2025 12:56:06
// \   \  /  \ 
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family virtex2p -w "C:/Documents and Settings/student/isetest/LAB2/dropfifo.sch" dropfifo.vf
...
module dropfifo(clk, 
   ...
   OR2 XLXI_4 (.I0(XLXN_12), 
               .I1(XLXN_2), 
               .O(XLXN_13));
   AND2B1 XLXI_5 (.I0(XLXN_33), 
                  .I1(XLXN_13), 
                  .O(XLXN_44));
   reg9B XLXI_6 (.ce(XLXN_51), 
                 .clk(clk), 
                 .clr(rst), 
                 .d(in_fifo[71:0]), 
                 .q(in_fifo0[71:0]));
   ...
   comp8_MUSER_dropfifo XLXI_8 (.A(waddr[7:0]), 
                                .B(raddr[7:0]), 
                                .EQ(XLXN_17));
   ...
   ram72 XLXI_17 (.addra(waddr[7:0]), 
                  ...
                  .wea(XLXN_45), 
                  .doutb(out_fifo[71:0]));
   AND3B2 XLXI_18 (.I0(XLXN_18), 
                   .I1(XLXN_17), 
                   .I2(fiforead), 
                   .O(XLXN_20));
   VCC XLXI_19 (.P(XLXN_51));
endmodule
